			...
			<div class="grid_3 grid_5">
				<div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
					...
					<div id="myTabContent" class="tab-content">
						...
						<?php
							$qry="SELECT * FROM product order by id desc limit 6";
							$res=mysqli_query($con,$qry);
							while($arr=mysqli_fetch_assoc($res)){
                                $d=$arr['price']-$arr['sale_price'];
												...
												<figure>
													<div class="snipcart-item block" >
														<div class="snipcart-thumb">
															<a href="products.html"><img title=" " alt=" " src="img/<?php echo $arr['image']; ?>" /></a>		
															<p><?= $arr['p_name'];?>
                                                                <input type="hidden" name="item" value="<?= $arr['p_name'];?>">	</p>
															<div class="stars">
															<?php for($t=1;$t<=5;$t++) { ?>
                                                            ...
                                                            <input type="hidden" name="price" value="<?= $arr['sale_price'];?>">	</p>
															
                                                            <div class="snipcart-details top_brand_home_details">
                                                                <input type="submit" name="submit" value="Add to cart" class="button" /> </div>
														</div>
						...
						<div role="tabpanel" class="tab-pane fade" id="tours" aria-labelledby="tours-tab">
                            ...
                            <div class="agile_top_brands_grids">
                            <?php
                            $qry="select * from todayoffer order by id desc limit 6 ";
                            $res=mysqli_query($con,$qry);
                           while( $ar=mysqli_fetch_assoc($res)){
                            $d=$ar['price']-$ar['sale_price'];
										...
										<div class="agile_top_brand_left_grid">
											...
											<div class="agile_top_brand_left_grid1">
												<figure>
													<div class="snipcart-item block" >
														<div class="snipcart-thumb">
															<a href="index.php"><img title=" " alt=" " src="img/<?=$ar['image'];?>" /></a>		
															<p><?= $ar['p_name'];?></p>
															<div class="stars">
																<?php
                                                                for($l=1;$l<=4;$l++){ ?>
															...
															<h4>Rs. <?= $ar['sale_price'];?> <span>Rs. <?= $ar['price'];?></span></h4>
														</div>
														<div class="snipcart-details top_brand_home_details">
												
																<fieldset>
																	
																	<input type="hidden" name="item" value="<?= $ar['p_name'];?>" />
																	<input type="hidden" name="price" value="<?= $ar['sale_price'];?>" />
